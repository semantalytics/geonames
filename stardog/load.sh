...
stardog-admin db create -n geonames --copy-server-side -o spatial.enabled=true search.enabled=true virtual.transparency=true query.all.graphs=true -- downloads/geonames_links.nt.bz2 downloads/ontology_v3.2.rdf downloads/mappings_v3.01.rdf
